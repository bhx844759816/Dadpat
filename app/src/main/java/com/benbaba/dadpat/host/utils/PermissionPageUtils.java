...
import com.benbaba.dadpat.host.BuildConfig;
...
public final class PermissionPageUtils {
    ...
    private static PermissionPageUtils mInstance;

    public static PermissionPageUtils getInstance(Context context) {
        if (mInstance == null) {
            synchronized (PermissionPageUtils.class) {
                if (mInstance == null)
                    mInstance = new PermissionPageUtils(context);
            }
        }
        return mInstance;
    }
    ...
    private void goXiaoMiManager() {
        ...
        L.e(TAG, "goMiaoMiManager --- rom : " + rom);
